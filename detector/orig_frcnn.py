...
dataset = MOT17ObjDetect('MOT17Det/train', get_transform(train=True))
...
def evaluate_and_write_result_files(model, data_loader):
  ...
  data_loader.dataset.write_results_files(results, './dir2/resnet50/')
...
for epoch in range(1, num_epochs + 1):
    ...
    if epoch % 3 == 0:
      ...
      torch.save(model.state_dict(), f"./dir1/model_epoch_{epoch}.model")
