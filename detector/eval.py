...
dataset_test = MOT17ObjDetect('MOT20Det/train', get_transform(train=False))
...
def evaluate_and_write_result_files(model, data_loader):
  ...
  data_loader.dataset.write_results_files(results, './out/')
...
for epoch in range(1, num_epochs + 1):
    ...
    if epoch % 3 == 0:
      ...
      torch.save(model.state_dict(), f"./faster_rcnn_fpn_training_mot_17/model_epoch_{epoch}.model")
'''
